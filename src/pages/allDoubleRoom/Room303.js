...
const Room303 = () => {
    ...
    return (
        ...
        <Helmet>
			...
			<meta name='description' content='Room-303' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-303</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    <span>
                        ...
                        <h2>Rent: $399 per night</h2>
                        <h2>Description:</h2>
                    </span>
                    <span >
                    <h4 style={{marginRight: "30px"}}>We have total six double rooms in AAST hotel. 
                    They are Room-301, Room-302, Room-303, Room-304, Room-305, Room-306. 
                    {/* change hare */}                    
                    Among them Room-303 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/6587907/pexels-photo-6587907.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 303</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Double</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $399</span>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    <Segment style={{}}>
                        ...
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 303</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Double</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $499</span>
                ...
                <h2>Description:</h2>
                    ...
                    <span >
                    <h4 style={{marginBottom: "30px"}}>We have total six double rooms in AAST hotel. They are Room-301, Room-302, Room-303, Room-304, Room-305, Room-306.
                    {/* chnage hare */}
                    Among them Room-303 is a very deluxe and luxurious room.</h4>
                    </span>
                </Grid>
