...
const Room201 = () => {
    ...
    return (
        ...
        <Helmet>
            {/* change hare */}
			<title>Room-201</title>
			<meta name='description' content='Room-201' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-201</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    {/* change hare */}                    
                    Among them Room-201 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                ...
                <Grid.Column>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 201</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Single</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $249</span>
