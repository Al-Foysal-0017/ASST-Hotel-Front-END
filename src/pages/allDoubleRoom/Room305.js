...
const Room305 = () => {
    ...
    return (
        ...
        <Helmet>
			...
			<meta name='description' content='Room-305' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-305</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    {/* change hare */}                    
                    Among them Room-305 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/271624/pexels-photo-271624.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 305</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Double</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $299</span>
