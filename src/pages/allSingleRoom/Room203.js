...
const Room203 = () => {
    ...
    return (
        ...
        <Helmet>
            {/* change hare */}
			<title>Room-203</title>
			<meta name='description' content='Room-203' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-203</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    {/* change hare */}                    
                    Among them Room-203 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/1103808/pexels-photo-1103808.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 203</span>
