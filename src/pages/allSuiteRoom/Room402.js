...
const Room402 = () => {
    ...
    return (
        ...
        <Helmet>
			...
			<meta name='description' content='Room-402' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-402</span>
            </Header>
            <div style={{marginBottom: '100px', textAlign: 'center'}}>
                <Link to="/suite-room" className="btn-primary">
                        Back To All-Suite-Rooms
                </Link> 
            </div>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    <span>
                        ...
                        <h2>Rent: $599 per night</h2>
                        <h2>Description:</h2>
                    </span>
                    <span >
                    <h4 style={{marginRight: "30px"}}>We have total four suite rooms in AAST hotel. 
                    They are Room-401, Room-402, Room-403, Room-404.
                    {/* change hare */}                    
                    Among them Room-402 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/1329711/pexels-photo-1329711.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 402</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Suite</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $599</span>
        ...
        <div className="responsiveMobile">
            ...
            <div>
                ...
                <h2>Description:</h2>
                    ...
                    <span >
                    <h4 style={{marginBottom: "30px"}}>We have total four suite rooms in AAST hotel. 
                    They are Room-401, Room-402, Room-403, Room-404.
                    Among them Room-402 is a very deluxe and luxurious room.</h4>
                    </span>
                </Grid>
