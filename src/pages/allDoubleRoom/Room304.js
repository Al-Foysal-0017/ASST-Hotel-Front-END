...
const Room304 = () => {
    ...
    return (
        ...
        <Helmet>
            {/* change hare */}
			<title>Room-304</title>
			<meta name='description' content='Room-304' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-304</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    {/* change hare */}                    
                    Among them Room-304 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/1743231/pexels-photo-1743231.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 304</span>
