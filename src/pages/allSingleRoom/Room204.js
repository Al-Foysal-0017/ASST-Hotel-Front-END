...
const Room204 = () => {
    ...
    return (
        ...
        <Helmet>
            {/* change hare */}
			<title>Room-204</title>
			<meta name='description' content='Room-204' />
		</Helmet>
		<Toaster
			position='top-center'
			reverseOrder={false}
        ...
        <div className="responsiveDesktop">
            ...
            <Header textAlign='center' style={{marginTop: '100px',fontSize: '26px', fontWeight: 'bold'}}>
                {/* change hare */}
                <span style={{fontSize:"40px"}}>Room-204</span>
            </Header>
            ...
            <div>
                ...
                <Grid.Column>
                    ...
                    {/* change hare */}                    
                    Among them Room-204 is a very deluxe and luxurious room.</h4>
                    </span>
                    {/* change image */}
                    <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/3754595/pexels-photo-3754595.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' />
                    </Container>
                </Grid.Column>
                <Grid.Column>
                    <Container>
                    ...
                    <Segment style={{ marginLeft: "30px"}}>
                        ...
                        {/* change hare */}
                        <span style={{fontSize: "20px", padding: "7px"}}>Room No: 204</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Room Type: Single</span>
                        <span style={{fontSize: "20px", padding: "7px"}}>Rent: $209</span>
        ...
        <div className="responsiveMobile">
            ...
            <div>
                ...
                {/* change image */}
                <Image className="perRoomImage" alt="" src='https://images.pexels.com/photos/2351290/pexels-photo-2351290.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' />
                <span>
                <h2>Description:</h2>
                </span>
                    <span >
